...
from annotation.widget.color_picker.view.eye_dropper.ScreenScraper import ScreenScraper
from annotation.widget.color_picker.view.eye_dropper.eye_dropper import EyeDropper
from annotation.widget.color_picker.view.color_monitor import ColorMonitor
from annotation.widget.color_picker.view.color_sliders import ColorSliders
from annotation.widget.color_picker.view.palette import BasicPalette
from annotation.widget.color_picker.view.palette import RecentPalette
from annotation.widget.color_picker.view.palette import CustomPalette

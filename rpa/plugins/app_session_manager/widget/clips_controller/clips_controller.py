...
from app_session_manager.widget.clips_controller.view.model import Model
from app_session_manager.widget.clips_controller.view.context_menu \
    import ContextMenu
from app_session_manager.widget.clips_controller.view.view import View
from app_session_manager.widget.clips_controller.view.header_view \
...
class ClipsController(QtCore.QObject):
    ...
    def __init__(
        ...
        self.__view.table.SIG_EMPTY_SPACE_CLICKED.connect(
            self.__selection_changed)

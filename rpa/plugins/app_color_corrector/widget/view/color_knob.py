...
from app_color_corrector.widget.view.color_panel import ColorPanel
from app_color_corrector.widget.view.slider import Slider
from rpa_widgets.sub_widgets.striped_frame import StripedFrame
from app_color_corrector.widget.utils import FormatNumber

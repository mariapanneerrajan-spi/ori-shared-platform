...
from annotation.widget.color_picker.view.color_sliders.color_slider import ColorSlider
from annotation.widget.color_picker.view.color_sliders.clearing_slider_label import ClearingSliderLabel

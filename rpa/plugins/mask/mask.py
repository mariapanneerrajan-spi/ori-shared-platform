...
RPA_APP_MASK_IMAGE = "RPA_APP_MASK_IMAGE"
...
class MaskPlugin:
    ...
    def __initialize_masks(self):
        mask_images = os.environ.get(RPA_APP_MASK_IMAGE)
        if mask_images:
    ...
    def __create_menu(self):
        ...
        masking_menu = QtWidgets.QMenu("Masking", view_menu)
        masking_menu.setTearOffEnabled(True)
        masking_menu.addAction(self.__actions.toggle_mask)
        masking_menu.addAction(self.__actions.cycle_mask)
        masking_menu.addAction(self.__actions.guess_mask)
        masking_menu.addSeparator()
        self.__mask_menu = QtWidgets.QMenu("Select Mask", masking_menu)
        masking_menu.addMenu(self.__mask_menu)

        view_menu.addSeparator()
        view_menu.addMenu(masking_menu)
        view_menu.addSeparator()

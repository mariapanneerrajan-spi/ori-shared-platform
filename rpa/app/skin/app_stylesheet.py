"""Application-wide Qt styling for App.
...
the main window. Call `apply_app_styling(app)` once at startup, after
the QApplication exists, before showing the main window.
"""

from rpa.app.skin.app_palette import AppPalette
...
def apply_app_styling(app):
    """Apply App's palette and stylesheet to the given QApplication."""

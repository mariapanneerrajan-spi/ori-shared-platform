...
from timeline.widget.view.range import TimelineRange
from timeline.widget.view.actions import Actions
from timeline.widget.view.slider import TimelineSlider
from timeline.widget.model.timeline_datatypes import RangeScope, SliderScope
...
class TimelineController(QtWidgets.QToolBar):
    ...
    SIG_RANGE_UPDATED = QtCore.Signal()
    ...
    def get_range_display(self):
        return self.__timeline_range.get_range_display()

    def set_range_display(self, mode:int):
        self.__timeline_range.set_range_display(mode)

    def get_range_scope(self):
        return self.__timeline_range.get_range_scope()

    def set_range_scope(self, mode:int):
        self.__timeline_range.set_range_scope(mode)

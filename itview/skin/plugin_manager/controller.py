...
class Controller(QtCore.QObject):
    ...
    def __setup_view(self):
        ...
        itview_menu = self.__main_window.get_menu("Itview")
        actions = itview_menu.actions()
        if actions:
            itview_menu.insertAction(actions[0], self.__toggle_plugins_manager_action)
        else:
            itview_menu.addAction(self.__toggle_plugins_manager_action)
        itview_menu.addSeparator()
    ...
    def __setup_core_preferences(self):
        ...
        itview_menu = self.__main_window.get_menu("Itview")
        itview_menu.addSeparator()
        itview_menu.addAction(self.__core_preferences_action)
    ...
    def __setup_settings_widget(self):
        ...
        itview_menu = self.__main_window.get_menu("Itview")
        itview_menu.addAction(self.__toggle_settings_action)
        itview_menu.addSeparator()
